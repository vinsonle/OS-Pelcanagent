   ...
   var DTI_ratio                  = $("#out_debt_to_income").val().trim();
    ...
    $.ajax({
                   ...
                   // alert(result);return false;
                        //$("#appendJson").html(result);
                        $("#home_price1").html(obj.home_price);
                        $("#mortage_payment1").html(obj.monthly_mortgage_payment);
                        //console.log(obj.total_monthly_mortgage_payment);
                        $("#insurance1").html(obj.homeowner_insurance);
                        $("#mortage_payment1").html(obj.total_monthly_mortgage_payment);
