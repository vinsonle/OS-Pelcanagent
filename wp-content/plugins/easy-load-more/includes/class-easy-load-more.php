...
class Easy_Load_More {
	...
	public function __construct ( $file = '', $version = '1.0.0' ) {
		define('EASY_LOAD_MORE_SCRIPT_DEBUG', false);
		...
		$this->script_suffix = defined( 'EASY_LOAD_MORE_SCRIPT_DEBUG' ) && EASY_LOAD_MORE_SCRIPT_DEBUG ? '' : '.min';
	...
	<script type="text/javascript">
		var elm_button_vars = { wrapper: '<?php echo get_option('elm_wrapper_selector'); ?>' };
	</script>
	<?php
	} // End localize_script ()
