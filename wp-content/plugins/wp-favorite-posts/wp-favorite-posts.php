...
function wpfp_link_html($post_id, $opt, $action) {
    $link = "<a class='wpfp-link' href='?wpfpaction=".$action."&amp;postid=". esc_attr($post_id) . "' title='". $opt ."' rel='nofollow'><span class='fav_text'><img src='/wp-content/themes/twentyseventeen-child/images/hearts.png' class='media-object' alt='img'></span></a>";
